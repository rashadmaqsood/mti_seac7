...
namespace DLMS
{
    ...
    /// HDLC Setup
    /// </summary>
    public class Class_23 : Base_Class
    {
        ...
        public CommSpeed Comm_Speed = CommSpeed._4800;
        ...
        public Class_23(Get_Index Index, byte[] Obis_Code, UInt16 No_of_Associations)
            : base(23, 9, 0, Index, Obis_Code, No_of_Associations)
        {
        }

        public Class_23(byte[] Obis_Code, byte Attribute_recieved)
            : base(23, 9, 0, Obis_Code)
        {
            DecodingAttribute = Attribute_recieved;
        }

        public Class_23(StOBISCode OBISCodeStruct)
        ...
        {
            Class_23 cloned = new Class_23(this);
            return cloned;
        }
