...
{
    public partial class ucTimeWindowParam2 : UserControl
    {
        ...
        internal void SaveTimeWindowParam()
        {
            ...
            if (_TBE.Control_Enum.Equals(Tb_DateTime)) //dateTime selected
            {
                ...
                //Validate dtDateTime
                if (dtDateTime.IsDateTimeValid && dtDateTime.IsValid)
                {
        ...
        private bool IsControlRDEnable(MeterScheduling type)
        {
            bool isEnable = false;
            try
            {
