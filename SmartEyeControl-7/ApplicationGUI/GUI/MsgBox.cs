...
namespace SmartEyeControl_7
{
    class MsgBox : Form
    {
        ...
        private MsgBox()
        {
            ...
            _lblMessage = new TextBox() {ScrollBars = ScrollBars.Both,Multiline = true,BackColor = this.BackColor };
            _lblMessage.ReadOnly = true;
        ...
        public static void Show(string message, string title)
        {
            ...
            var _msgBox_Size = MsgBox.MessageSize(message);
            var T_MAXSize = _msgBox.MaximumSize;

            int tWidth = (_msgBox_Size.Width >= T_MAXSize.Width) ? T_MAXSize.Width : _msgBox_Size.Width;
            int tHeight = (_msgBox_Size.Height >= T_MAXSize.Height) ? T_MAXSize.Height : _msgBox_Size.Height;

           // _msgBox.Size = _msgBox_Size;
            _msgBox.Size = new Size(tWidth, tHeight);
        ...
        public static DialogResult Show(string message, string title, Buttons buttons, Icon icon, AnimateStyle style)
        {
            ...
            int tWidth = (_msgBox_Size.Width >= T_MAXSize.Width && 
                          T_MAXSize.Width != 0) ? T_MAXSize.Width : _msgBox_Size.Width;

            int tHeight = (_msgBox_Size.Height >= T_MAXSize.Height && 
                           T_MAXSize.Height != 0) ? T_MAXSize.Height : _msgBox_Size.Height;

            // _msgBox.Size = _msgBox_Size;
            Size formSize  = new Size(tWidth, tHeight);
