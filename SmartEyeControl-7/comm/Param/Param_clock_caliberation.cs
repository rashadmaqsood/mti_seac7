...
namespace comm
{
    ...
    public class Param_clock_caliberation : IParam, ICloneable
    {
        ...
        [XmlElement("Clock_Calibration_PPM", typeof(ushort))]
        ...
        public void Decode_Daylight_Saving_Deviation(Base_Class arg)
        {
            try
            {
                Class_8 Meter_Clock = (Class_8)arg;
                ///Verify data Received/OBIS/ETC
                if (Meter_Clock.GetAttributeDecodingResult(7) == DecodingResult.Ready)
                    ///Update Only If Value Received Correctly
        ...
        #region Clock Calibration Flags
