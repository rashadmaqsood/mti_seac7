...
namespace DatabaseConfiguration.DataBase
{
    ...
    public class SEAC_DBAccessLayer : SEAC_DAO
    {
        public SEAC_DBAccessLayer(string connectionString)
        ...
        public void Load_All_Configurations(ref Configs AllDataSet)
        {
            try
            {
                ...
                //UsersSEAC_DAO UserSEAC_DAO = new UsersSEAC_DAO();
                //UserSEAC_DAO.LoadUser(AllDataSet);

                // All Configuration Groups
                OBISRightsGroupSEAC_DAO OBIS_RightsGroupSEAC_DAO = new OBISRightsGroupSEAC_DAO(this.DataBaseConnection);
                OBIS_RightsGroupSEAC_DAO.LoadOBISRightsGroup(AllDataSet);

                EventsGroupSEAC_DAO egroupSEAC_DAO = new EventsGroupSEAC_DAO(this.DataBaseConnection);
                egroupSEAC_DAO.LoadEventsGroup(AllDataSet);

                BillingItemGroupSEAC_DAO bgroupSEAC_DAO = new BillingItemGroupSEAC_DAO(this.DataBaseConnection);
                bgroupSEAC_DAO.LoadBillingItemGroup(AllDataSet);

                DisplayWindowsGroupSEAC_DAO dgroupSEAC_DAO = new DisplayWindowsGroupSEAC_DAO(this.DataBaseConnection);
                dgroupSEAC_DAO.LoadDisplayWindowsGroup(AllDataSet);

                LoadProfileGroupSEAC_DAO lgroupSEAC_DAO = new LoadProfileGroupSEAC_DAO(this.DataBaseConnection);
                lgroupSEAC_DAO.LoadLoadProfileGroup(AllDataSet);

                StatusWordSEAC_DAO statusWordSEAC_DAO = new StatusWordSEAC_DAO(this.DataBaseConnection);
                statusWordSEAC_DAO.LoadStatusWord(AllDataSet);


                AllQuantitiesSEAC_DAO allQuantities = new AllQuantitiesSEAC_DAO(this.DataBaseConnection);
                allQuantities.Load_ObisLabels(AllDataSet);

                ManufacturerSEAC_DAO manufacturerSEAC_DAO = new ManufacturerSEAC_DAO(this.DataBaseConnection);
                manufacturerSEAC_DAO.LoadManufacturer(AllDataSet);

                AuthenticationTypeSEAC_DAO authenticationTypeSEAC_DAO = new AuthenticationTypeSEAC_DAO(this.DataBaseConnection);
                authenticationTypeSEAC_DAO.LoadAuthenticationType(AllDataSet);

                DeviceSEAC_DAO deviceSEAC_DAO = new DeviceSEAC_DAO(this.DataBaseConnection);
                deviceSEAC_DAO.LoadDevice(AllDataSet);

                DeviceAssociationSEAC_DAO deviceAssociationSEAC_DAO = new DeviceAssociationSEAC_DAO(this.DataBaseConnection);
                deviceAssociationSEAC_DAO.LoadDeviceAssociation(AllDataSet);

                OBISDetailsSEAC_DAO ObisDetails = new OBISDetailsSEAC_DAO(this.DataBaseConnection);
                ...
                OBISRithtsSEAC_DAO OBIS_RightsSEAC_DAO = new OBISRithtsSEAC_DAO(this.DataBaseConnection);
                OBIS_RightsSEAC_DAO.Load_OBIS_Rights(AllDataSet);

                // Dt = (Configs)AllDataSet.Rights.DataSet.Copy();
                RithtsSEAC_DAO RightsSEAC_DAO = new RithtsSEAC_DAO(this.DataBaseConnection);
                RightsSEAC_DAO.Load_Rights(AllDataSet);

                ConfigurationSEAC_DAO ConfigSEAC_DAO = new ConfigurationSEAC_DAO(this.DataBaseConnection);
                ConfigSEAC_DAO.LoadMeterConfiguraion(AllDataSet);


                DisplayWindowSEAC_DAO DispWinSEAC_DAO = new DisplayWindowSEAC_DAO(this.DataBaseConnection);
                DispWinSEAC_DAO.Load_Display_Windows(AllDataSet);

                LoadProfileSEAC_DAO LoadProfileSEAC_DAO = new LoadProfileSEAC_DAO(this.DataBaseConnection);
                LoadProfileSEAC_DAO.Load_Profiles(AllDataSet);

                BillItemSEAC_DAO BillSEAC_DAO = new BillItemSEAC_DAO(this.DataBaseConnection);
                BillSEAC_DAO.Load_Billing_Items(AllDataSet);

                BillTariffSEAC_DAO BillTariffSEAC_DAO = new BillTariffSEAC_DAO(this.DataBaseConnection);
                BillTariffSEAC_DAO.Load_Billing_Tariff(AllDataSet);

                EventInfoSEAC_DAO EventInfoSEAC_DAO = new EventInfoSEAC_DAO(this.DataBaseConnection);
                EventInfoSEAC_DAO.Load_EventProfileInfo(AllDataSet);

                EventLogsSEAC_DAO EventLogSEAC_DAO = new EventLogsSEAC_DAO(this.DataBaseConnection);
                EventLogSEAC_DAO.Load_EventLogsInfo(AllDataSet);
            }
            catch (Exception ex)
            {
        ...
        // public void Load_OBISCodes(Configs AllDataSet, Configs.Meter_ConfigurationRow CurrentMeter)
        // {
        //     try
        //     {
        //         // Load Server And Client SAP Info Of Current Meter
        //         List<Configs.Sap_ConfigRow> MeterSAPs = (from conf in AllDataSet.Sap_Config
        //                                                  where conf.Meter_Config_id == CurrentMeter.id
        //                                                  orderby conf.id
        //                                                  select conf).ToList<Configs.Sap_ConfigRow>();

        //         if (MeterSAPs == null || MeterSAPs.Count <= 0)
        //         {
        //             SAPConfigSEAC_DAO SAPSEAC_DAO = new SAPConfigSEAC_DAO();
        //             SAPSEAC_DAO.Load_SAP_Info_ByMeter(AllDataSet, CurrentMeter);

        //             MeterSAPs = (from conf in AllDataSet.Sap_Config
        //                          where conf.Meter_Config_id == CurrentMeter.id
        //                          orderby conf.id
        //                          select conf).ToList<Configs.Sap_ConfigRow>();
        //         }
        //         // Load OBIS_Rights
        //         OBISRithtsSEAC_DAO OBIS_CodeRightsSEAC_DAO = new OBISRithtsSEAC_DAO();
        //         OBIS_CodeRightsSEAC_DAO.Load_OBISRightsBySAPInfo(AllDataSet, MeterSAPs);

        //         // Load OBIS_Rights
        //         RithtsSEAC_DAO RightsSEAC_DAO = new RithtsSEAC_DAO();
        //         RightsSEAC_DAO.Load_RightsByOBISRightId(AllDataSet, AllDataSet.OBIS_Rights.ToList<Configs.OBIS_RightsRow>());
        ...
        public void Update_All_Configuration(Configs AllDataSet)
        {
            try
            {
                ...
                using (IDbTransaction transection = this.DataBaseConnection.BeginTransaction(IsolationLevel.ReadCommitted))
                {
                    ...
                    UsersSEAC_DAO UserSEAC_DAO = new UsersSEAC_DAO(this.DataBaseConnection);
                    UserSEAC_DAO.Transaction = transection;
                    UserSEAC_DAO.AcceptChangesUser(Dt);


                    EventsGroupSEAC_DAO egroupSEAC_DAO = new EventsGroupSEAC_DAO(this.DataBaseConnection);
                    egroupSEAC_DAO.Transaction = transection;
                    egroupSEAC_DAO.AcceptChangesEventsGroup(Dt);

                    BillingItemGroupSEAC_DAO bgroupSEAC_DAO = new BillingItemGroupSEAC_DAO(this.DataBaseConnection);
                    bgroupSEAC_DAO.Transaction = transection;
                    bgroupSEAC_DAO.AcceptChangesBillingItemGroup(Dt);

                    DisplayWindowsGroupSEAC_DAO dgroupSEAC_DAO = new DisplayWindowsGroupSEAC_DAO(this.DataBaseConnection);
                    dgroupSEAC_DAO.Transaction = transection;
                    dgroupSEAC_DAO.AcceptChangesDisplayWindowsGroup(Dt);

                    LoadProfileGroupSEAC_DAO lgroupSEAC_DAO = new LoadProfileGroupSEAC_DAO(this.DataBaseConnection);
                    lgroupSEAC_DAO.Transaction = transection;
                    lgroupSEAC_DAO.AcceptChangesLoadProfileGroup(Dt);

                    OBISRightsGroupSEAC_DAO oBISRightsGroupSEAC_DAO = new OBISRightsGroupSEAC_DAO(this.DataBaseConnection);
                    oBISRightsGroupSEAC_DAO.Transaction = transection;
                    oBISRightsGroupSEAC_DAO.AcceptChangesOBISRightsGroup(Dt);


                    // UpdateMeterTypeInfo(Dt);
                    // Dt = (Configs)AllDataSet.Configuration.DataSet.GetChanges();
                    ConfigurationSEAC_DAO ConfigSEAC_DAO = new ConfigurationSEAC_DAO(this.DataBaseConnection);
                    ConfigSEAC_DAO.Transaction = transection;
                    ConfigSEAC_DAO.AcceptChangesConfiguration(Dt);

                    StatusWordSEAC_DAO statusWordSEAC_DAO = new StatusWordSEAC_DAO(this.DataBaseConnection);
                    statusWordSEAC_DAO.Transaction = transection;
                    statusWordSEAC_DAO.AcceptChangesStatusWord(Dt);
                    ...
                    ManufacturerSEAC_DAO manufacturerSEAC_DAO = new ManufacturerSEAC_DAO(this.DataBaseConnection);
                    manufacturerSEAC_DAO.Transaction = transection;
                    manufacturerSEAC_DAO.AcceptChangesManufacturer(Dt);

                    AuthenticationTypeSEAC_DAO authenticationTypeSEAC_DAO = new AuthenticationTypeSEAC_DAO(this.DataBaseConnection);
                    authenticationTypeSEAC_DAO.Transaction = transection;
                    authenticationTypeSEAC_DAO.AcceptChangesAuthenticationType(Dt);

                    DeviceSEAC_DAO deviceSEAC_DAO = new DeviceSEAC_DAO(this.DataBaseConnection);
                    deviceSEAC_DAO.Transaction = transection;
                    deviceSEAC_DAO.AcceptChangesDevice(Dt);

                    DeviceAssociationSEAC_DAO deviceAssociationSEAC_DAO = new DeviceAssociationSEAC_DAO(this.DataBaseConnection);
                    deviceAssociationSEAC_DAO.Transaction = transection;
                    deviceAssociationSEAC_DAO.AcceptChangesDeviceAssociation(Dt);
                    ...
                    // Dt = (Configs)AllDataSet.OBIS_Rights.DataSet.Copy();
                    OBISRithtsSEAC_DAO OBIS_RightsSEAC_DAO = new OBISRithtsSEAC_DAO(this.DataBaseConnection);
                    OBIS_RightsSEAC_DAO.Transaction = transection;
                    OBIS_RightsSEAC_DAO.AcceptChangesOBIS_Rights(AllDataSet);

                    // Dt = (Configs)AllDataSet.Rights.DataSet.Copy();
                    RithtsSEAC_DAO RightsSEAC_DAO = new RithtsSEAC_DAO(this.DataBaseConnection);
                    RightsSEAC_DAO.Transaction = transection;
                    RightsSEAC_DAO.AcceptChanges_Rights(Dt);

                    DisplayWindowSEAC_DAO DispWinSEAC_DAO = new DisplayWindowSEAC_DAO(this.DataBaseConnection);
                    DispWinSEAC_DAO.Transaction = transection;
                    DispWinSEAC_DAO.AcceptChanges_Display_Windows(Dt);

                    LoadProfileSEAC_DAO LoadProfileSEAC_DAO = new LoadProfileSEAC_DAO(this.DataBaseConnection);
                    LoadProfileSEAC_DAO.Transaction = transection;
                    LoadProfileSEAC_DAO.AcceptChanges_Load_Profiles(Dt);

                    BillItemSEAC_DAO BillSEAC_DAO = new BillItemSEAC_DAO(this.DataBaseConnection);
                    BillSEAC_DAO.Transaction = transection;
                    BillSEAC_DAO.AcceptChanges_BillingItems(Dt);

                    BillTariffSEAC_DAO BillTariffSEAC_DAO = new BillTariffSEAC_DAO(this.DataBaseConnection);
                    BillTariffSEAC_DAO.Transaction = transection;
                    BillTariffSEAC_DAO.AcceptChanges_BillingTariff(Dt);

                    EventInfoSEAC_DAO EventInfoSEAC_DAO = new EventInfoSEAC_DAO(this.DataBaseConnection);
                    EventInfoSEAC_DAO.Transaction = transection;
                    EventInfoSEAC_DAO.AcceptChanges_EventProfileInfo(Dt);

                    EventLogsSEAC_DAO EventLogSEAC_DAO = new EventLogsSEAC_DAO(this.DataBaseConnection);
                    EventLogSEAC_DAO.Transaction = transection;
                    EventLogSEAC_DAO.AcceptChanges_EventProfileInfo(Dt);
    ...
    public class SEAC_DAO : IDisposable
    {
        ...
        public string ConnectionString
        {
            ...
            //{
                ...
                //    Connection = Settings.Default.SEAC_DBConnectionString;
                //    return Connection;
                //}
                //catch (Exception ex)
                //{
            ...
            //{
                ...
                //{
                //    Settings.Default["SEAC_DBConnectionString"] = value;
                //    Settings.Default.Save();
                //}
            //}
        }

        public SEAC_DAO(string connectionString)
        {
            try
            {
        ...
        public SEAC_DAO(IDbConnection Conn)
        {
            try
            {
    ...
    #region ManufacturerSEAC_DAO

    public class ManufacturerSEAC_DAO : SEAC_DAO
    {
        #region Data Members
        ...
        public ManufacturerSEAC_DAO(string connectionString)
            : base(connectionString)
        { }
        public ManufacturerSEAC_DAO(IDbConnection connection)
            : base(connection)
        { }
        ...
        public void InsertManufacturer(Configs.ManufacturerRow Row)
        {
            try
            {
                ...
                {
                    OleDbCommand cmd = GetCommand(ManufacturerSEAC_DAO.Insert);
                    cmd.Parameters.Add(new OleDbParameter(ManufacturerSEAC_DAO.IdParam, Row.id));
                    cmd.Parameters.Add(new OleDbParameter(ManufacturerSEAC_DAO.Manufacturer_Name, Row.Manufacturer_Name));
                    cmd.Parameters.Add(new OleDbParameter(ManufacturerSEAC_DAO.Code, Row.Code));
                    //cmd.Parameters.Add(new OleDbParameter(MeterTypeInfoSEAC_DAO.FirmWareVersionParam, Row.FirmWareVersion));
        ...
        public void UpdateManufacturer(Configs.ManufacturerRow Row)
        {
            try
            {
                ...
                {
                    OleDbCommand cmd = GetCommand(ManufacturerSEAC_DAO.Update);
                    ///Reflected Changes Parameters
                    cmd.Parameters.Add(new OleDbParameter(ManufacturerSEAC_DAO.Manufacturer_Name, Row.Manufacturer_Name));
                    cmd.Parameters.Add(new OleDbParameter(ManufacturerSEAC_DAO.Code, Row.Code));

                    /// Parameters Before Modification
                    cmd.Parameters.Add(new OleDbParameter(ManufacturerSEAC_DAO.IdParam + "_", Convert.ToInt32(Row["id", DataRowVersion.Original])));
        ...
        public void DeleteManufacturer(Configs.ManufacturerRow Row)
        {
            try
            {
                ...
                {
                    OleDbCommand cmd = GetCommand(ManufacturerSEAC_DAO.Delete);
                    cmd.Parameters.Add(new OleDbParameter(ManufacturerSEAC_DAO.IdParam + "_", Convert.ToInt32(Row["id", DataRowVersion.Original])));
                    cmd.ExecuteNonQuery();
                    //Row.AcceptChanges();
                }
    ...
    #region DeviceSEAC_DAO

    public class DeviceSEAC_DAO : SEAC_DAO
    {
        #region Data Members
        ...
        public DeviceSEAC_DAO(string connectionString)
            : base(connectionString)
        { }
        public DeviceSEAC_DAO(IDbConnection connection)
            : base(connection)
        { }
        ...
        public void InsertDevice(Configs.DeviceRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Added)
                {
                    OleDbCommand cmd = GetCommand(DeviceSEAC_DAO.Insert);
                    cmd.Parameters.Add(new OleDbParameter(DeviceSEAC_DAO.IdParam, Row.id));
                    cmd.Parameters.Add(new OleDbParameter(DeviceSEAC_DAO.Device_Name, Row.Device_Name));
                    cmd.Parameters.Add(new OleDbParameter(DeviceSEAC_DAO.Model, Row.Model));
                    cmd.Parameters.Add(new OleDbParameter(DeviceSEAC_DAO.Manufacturer_Id, Row.Manufacturer_Id));
                    cmd.Parameters.Add(new OleDbParameter(DeviceSEAC_DAO.IsSinglePhase, Row.IsSinglePhase));
                    //cmd.Parameters.Add(new OleDbParameter(MeterTypeInfoSEAC_DAO.FirmWareVersionParam, Row.FirmWareVersion));
                    int res = cmd.ExecuteNonQuery();
                    //Row.AcceptChanges();
                }
        ...
        public void UpdateDevice(Configs.DeviceRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Modified)
                {
                    OleDbCommand cmd = GetCommand(DeviceSEAC_DAO.Update);
                    ///Reflected Changes Parameters
                    cmd.Parameters.Add(new OleDbParameter(DeviceSEAC_DAO.Device_Name, Row.Device_Name));
                    cmd.Parameters.Add(new OleDbParameter(DeviceSEAC_DAO.Model, Row.Model));
                    cmd.Parameters.Add(new OleDbParameter(DeviceSEAC_DAO.Manufacturer_Id, Row.Manufacturer_Id));
                    cmd.Parameters.Add(new OleDbParameter(DeviceSEAC_DAO.IsSinglePhase, Row.IsSinglePhase));
                    /// Parameters Before Modification
                    cmd.Parameters.Add(new OleDbParameter(DeviceSEAC_DAO.IdParam + "_", Convert.ToInt32(Row["id", DataRowVersion.Original])));
        ...
        public void DeleteDevice(Configs.DeviceRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Deleted)
                {
                    OleDbCommand cmd = GetCommand(DeviceSEAC_DAO.Delete);
    ...
    #region AuthenticationTypeSEAC_DAO

    public class AuthenticationTypeSEAC_DAO : SEAC_DAO
    {
        #region Data Members
        ...
        public AuthenticationTypeSEAC_DAO(string connectionString)
            : base(connectionString)
        { }
        public AuthenticationTypeSEAC_DAO(IDbConnection connection)
            : base(connection)
        { }
        ...
        public void InsertAuthenticationType(Configs.Authentication_TypeRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Added)
                {
                    OleDbCommand cmd = GetCommand(AuthenticationTypeSEAC_DAO.Insert);
                    cmd.Parameters.Add(new OleDbParameter(AuthenticationTypeSEAC_DAO.IdParam, Row.id));
                    cmd.Parameters.Add(new OleDbParameter(AuthenticationTypeSEAC_DAO.Authentication_Type_Name, Row.Authentication_Type_Name));
                    //cmd.Parameters.Add(new OleDbParameter(MeterTypeInfoSEAC_DAO.FirmWareVersionParam, Row.FirmWareVersion));
                    int res = cmd.ExecuteNonQuery();
                    //Row.AcceptChanges();
                }
        ...
        public void UpdateAuthenticationType(Configs.Authentication_TypeRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Modified)
                {
                    OleDbCommand cmd = GetCommand(AuthenticationTypeSEAC_DAO.Update);
                    ///Reflected Changes Parameters
                    cmd.Parameters.Add(new OleDbParameter(AuthenticationTypeSEAC_DAO.Authentication_Type_Name, Row.Authentication_Type_Name));
                    /// Parameters Before Updation
                    cmd.Parameters.Add(new OleDbParameter(AuthenticationTypeSEAC_DAO.IdParam + "_", Convert.ToInt32(Row["id", DataRowVersion.Original])));
                    int res = cmd.ExecuteNonQuery();
                    //if (res > 0)
                    //    Row.AcceptChanges();
                }
        ...
        public void DeleteAuthenticationType(Configs.Authentication_TypeRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Deleted)
                {
                    OleDbCommand cmd = GetCommand(AuthenticationTypeSEAC_DAO.Delete);
                    /// Parameters Before Deletion
                    cmd.Parameters.Add(new OleDbParameter(AuthenticationTypeSEAC_DAO.IdParam + "_", Convert.ToInt32(Row["id", DataRowVersion.Original])));
                    cmd.ExecuteNonQuery();
                    //Row.AcceptChanges();
    ...
    public class DeviceAssociationSEAC_DAO : SEAC_DAO
    {
        ...
        public DeviceAssociationSEAC_DAO(string connectionString)
            : base(connectionString)
        { }
        public DeviceAssociationSEAC_DAO(IDbConnection connection)
            : base(connection)
        { }
        ...
        public void InsertDeviceAssociation(Configs.Device_AssociationRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Added)
                {
                    OleDbCommand cmd = GetCommand(DeviceAssociationSEAC_DAO.Insert);
                    cmd.Parameters.Add(new OleDbParameter(DeviceAssociationSEAC_DAO.IdParam, Row.id));
                    cmd.Parameters.Add(new OleDbParameter(DeviceAssociationSEAC_DAO.Association_Name, Row.Association_Name));
                    cmd.Parameters.Add(new OleDbParameter(DeviceAssociationSEAC_DAO.Authentication_Type_Id, Row.Authentication_Type_Id));
                    cmd.Parameters.Add(new OleDbParameter(DeviceAssociationSEAC_DAO.Client_Sap, Row.Client_Sap));
                    cmd.Parameters.Add(new OleDbParameter(DeviceAssociationSEAC_DAO.Meter_Sap, Row.Meter_Sap));
                    cmd.Parameters.Add(new OleDbParameter(DeviceAssociationSEAC_DAO.Device_Id, Row.Device_Id));
                    cmd.Parameters.Add(new OleDbParameter(DeviceAssociationSEAC_DAO.Configuration_Id, Row.Configuration_Id));
                    cmd.Parameters.Add(new OleDbParameter(DeviceAssociationSEAC_DAO.ObisRightGroupId, Row.ObisRightGroupId));
                    cmd.Parameters.Add(new OleDbParameter(DeviceAssociationSEAC_DAO.Reload_Config, Row.Reload_Config));
                    int res = cmd.ExecuteNonQuery();
            ...
            {
                throw new Exception("Error saving DeviceAssociationSEAC_DAO data in data source", ex);
            }
        }
        ...
        public void UpdateDeviceAssociation(Configs.Device_AssociationRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Modified)
                {
                    OleDbCommand cmd = GetCommand(DeviceAssociationSEAC_DAO.Update);
                    ///Reflected Changes Parameters
                    cmd.Parameters.Add(new OleDbParameter(DeviceAssociationSEAC_DAO.Association_Name, Row.Association_Name));
                    cmd.Parameters.Add(new OleDbParameter(DeviceAssociationSEAC_DAO.Authentication_Type_Id, Row.Authentication_Type_Id));
                    cmd.Parameters.Add(new OleDbParameter(DeviceAssociationSEAC_DAO.Client_Sap, Row.Client_Sap));
                    ...
                    /// Parameters Before Updation
                    cmd.Parameters.Add(new OleDbParameter(DeviceAssociationSEAC_DAO.IdParam + "_", Convert.ToInt32(Row["id", DataRowVersion.Original])));
                    int res = cmd.ExecuteNonQuery();
                    //if (res > 0)
                    //    Row.AcceptChanges();
                }
        ...
        public void DeleteDeviceAssociation(Configs.Device_AssociationRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Deleted)
                {
                    OleDbCommand cmd = GetCommand(DeviceAssociationSEAC_DAO.Delete);
                    /// Parameters Before Deletion
                    cmd.Parameters.Add(new OleDbParameter(DeviceAssociationSEAC_DAO.IdParam + "_", Convert.ToInt32(Row["id", DataRowVersion.Original])));
                    cmd.ExecuteNonQuery();
                    //Row.AcceptChanges();
    ...
    #region UsersSEAC_DAO

    public class UsersSEAC_DAO : SEAC_DAO
    {
        #region Data Members
        ...
        public UsersSEAC_DAO(string connectionString)
            : base(connectionString)
        { }
        public UsersSEAC_DAO(IDbConnection connection)
            : base(connection)
        { }
        ...
        public void InsertUser(Configs.usersRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Added)
                {
                    OleDbCommand cmd = GetCommand(UsersSEAC_DAO.Insert);
                    cmd.Parameters.Add(new OleDbParameter(UsersSEAC_DAO.UserName, Row.user_name));
                    cmd.Parameters.Add(new OleDbParameter(UsersSEAC_DAO.UserPassword, Row.user_password));
                    cmd.Parameters.Add(new OleDbParameter(UsersSEAC_DAO.UserType, Row.user_type));
                    int res = cmd.ExecuteNonQuery();
                    //Row.AcceptChanges();
                }
                #endregion
        ...
        public void UpdateUser(Configs.usersRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Modified)
                {
                    OleDbCommand cmd = GetCommand(UsersSEAC_DAO.Update);
                    ///Reflected Changes Parameters
                    cmd.Parameters.Add(new OleDbParameter(UsersSEAC_DAO.UserName, Row.user_name));
                    cmd.Parameters.Add(new OleDbParameter(UsersSEAC_DAO.UserPassword, Row.user_password));
                    cmd.Parameters.Add(new OleDbParameter(UsersSEAC_DAO.UserType, Row.user_type));
                    ///Before Changes Parameters
                    cmd.Parameters.Add(new OleDbParameter(UsersSEAC_DAO.UserName + "_", Convert.ToString(Row["user_name", DataRowVersion.Original])));
                    int res = cmd.ExecuteNonQuery();
                    //if (res > 0)
                    //    Row.AcceptChanges();
                }
        ...
        public void DeleteMeterUser(Configs.usersRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Deleted)
                {
                    OleDbCommand cmd = GetCommand(UsersSEAC_DAO.Delete);
                    cmd.Parameters.Add(new OleDbParameter(UsersSEAC_DAO.UserName + "_", Row.user_name));
                    cmd.ExecuteNonQuery();
                    //Row.AcceptChanges();
                }
                #endregion
    ...
    public class ConfigurationSEAC_DAO : SEAC_DAO
    {
        #region Data Members
        ...
        public ConfigurationSEAC_DAO(string connectionString)
            : base(connectionString)
        { }
        public ConfigurationSEAC_DAO(IDbConnection connection)
            : base(connection)
        { }
        ...
        public void InsertConfiguration(Configs.ConfigurationRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Added)
                {
                    OleDbCommand cmd = GetCommand(ConfigurationSEAC_DAO.Insert);
                    cmd.Parameters.Add(new OleDbParameter(ConfigurationSEAC_DAO.IdParam, Row.id));
                    cmd.Parameters.Add(new OleDbParameter(ConfigurationSEAC_DAO.NameParam, Row.Name));

                    cmd.Parameters.Add(new OleDbParameter(ConfigurationSEAC_DAO.LpChannelsGroupId, OleDbType.BigInt) { Value = (Row.Islp_channels_group_idNull()) ? DBNull.Value : (object)Row.lp_channels_group_id });

                    cmd.Parameters.Add(new OleDbParameter(ConfigurationSEAC_DAO.BillItemsGroupId, OleDbType.BigInt) { Value = (Row.IsBillItemsGroupIdNull()) ? DBNull.Value : (object)Row.BillItemsGroupId });

                    //cmd.Parameters.Add(new OleDbParameter(ConfigurationSEAC_DAO.DisplayWindowGroupId, OleDbType.BigInt) { Value = (Row.IsDisplayWindowGroupIdNull()) ? DBNull.Value : (object)Row.DisplayWindowGroupId });


                    cmd.Parameters.Add(new OleDbParameter(ConfigurationSEAC_DAO.EventGroupId, OleDbType.BigInt) { Value = (Row.IsEventGroupIdNull()) ? DBNull.Value : (object)Row.EventGroupId });
        ...
        public void UpdateConfiguration(Configs.ConfigurationRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Modified)
                {
                    OleDbCommand cmd = GetCommand(ConfigurationSEAC_DAO.Update);
                    ...
                    /// Parameters Before Modification
                    cmd.Parameters.Add(new OleDbParameter(ConfigurationSEAC_DAO.IdParam + "_", Convert.ToInt32(Row["id", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(ConfigurationSEAC_DAO.NameParam + "_", Convert.ToString(Row["Name", DataRowVersion.Original])));


                    cmd.Parameters.Add(new OleDbParameter(ConfigurationSEAC_DAO.LpChannelsGroupId + "_", OleDbType.BigInt)
                    {
                    ...
                    cmd.Parameters.Add(new OleDbParameter(ConfigurationSEAC_DAO.BillItemsGroupId + "_", OleDbType.BigInt)
                    {
                    ...
                    cmd.Parameters.Add(new OleDbParameter(ConfigurationSEAC_DAO.DisplayWindowGroupId + "_", OleDbType.BigInt)
                    {
                    ...
                    cmd.Parameters.Add(new OleDbParameter(ConfigurationSEAC_DAO.EventGroupId + "_", OleDbType.BigInt)
                    {
        ...
        public void DeleteConfiguration(Configs.ConfigurationRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Deleted)
                {
                    OleDbCommand cmd = GetCommand(ConfigurationSEAC_DAO.Delete);
                    /// Parameters Before Modification
                    cmd.Parameters.Add(new OleDbParameter(ConfigurationSEAC_DAO.IdParam + "_", Convert.ToInt32(Row["id", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(ConfigurationSEAC_DAO.NameParam + "_", Convert.ToString(Row["Name", DataRowVersion.Original])));
    ...
    public class AllQuantitiesSEAC_DAO : SEAC_DAO
    {
        #region Data Members

        public static readonly string Select = "Select * from [AllQuantities] order by [OBIS_Index]";
        ...
        public AllQuantitiesSEAC_DAO(string connectionString)
            : base(connectionString)
        {

        }
        public AllQuantitiesSEAC_DAO(IDbConnection connection)
            : base(connection)
        { }
        ...
        public void InsertAllQuantities(Configs.AllQuantitiesRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Added)
                {
                    OleDbCommand cmd = GetCommand(AllQuantitiesSEAC_DAO.Insert);
                    cmd.Parameters.Add(new OleDbParameter(AllQuantitiesSEAC_DAO.OBIS_Index, Row.OBIS_Index));
                    cmd.Parameters.Add(new OleDbParameter(AllQuantitiesSEAC_DAO.Label, Row.Label));
                    cmd.ExecuteNonQuery();
                    //Row.AcceptChanges();
        ...
        public void UpdateAllQuantities(Configs.AllQuantitiesRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Modified)
                {
                    OleDbCommand cmd = GetCommand(AllQuantitiesSEAC_DAO.Update);
                    // Parameters Reflecting Modification
                    cmd.Parameters.Add(new OleDbParameter(AllQuantitiesSEAC_DAO.OBIS_Index, Row.OBIS_Index));
                    cmd.Parameters.Add(new OleDbParameter(AllQuantitiesSEAC_DAO.Label, Row.Label));
                    // Parameters Before Modification
                    cmd.Parameters.Add(new OleDbParameter(AllQuantitiesSEAC_DAO.OBIS_Index + "_", Convert.ToUInt64(Row["OBIS_Index", DataRowVersion.Original])));
                    cmd.ExecuteNonQuery();
                    // Row.AcceptChanges();
                }
                #endregion
        ...
        public void DeleteAllQuantities(Configs.AllQuantitiesRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Deleted)
                {
                    OleDbCommand cmd = GetCommand(AllQuantitiesSEAC_DAO.Delete);
                    cmd.Parameters.Add(new OleDbParameter(AllQuantitiesSEAC_DAO.OBIS_Index + "_", Convert.ToUInt64(Row["OBIS_Index", DataRowVersion.Original])));
    ...
    public class OBISDetailsSEAC_DAO : SEAC_DAO
    {
        #region Data Members
        ...
        public OBISDetailsSEAC_DAO(string connectionString)
            : base(connectionString)
        {

        }
        public OBISDetailsSEAC_DAO(IDbConnection connection)
            : base(connection)
        { }
        ...
        public void InsertOBISDetails(Configs.OBIS_DetailsRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Added)
                {
                    OleDbCommand cmd = GetCommand(OBISDetailsSEAC_DAO.Insert);
                    cmd.Parameters.Add(new OleDbParameter(OBISDetailsSEAC_DAO.IdParam, Row.id));
                    cmd.Parameters.Add(new OleDbParameter(OBISDetailsSEAC_DAO.Obis_Code, Row.Obis_Code));
                    cmd.Parameters.Add(new OleDbParameter(OBISDetailsSEAC_DAO.Default_OBIS_Code, Row.Default_OBIS_Code));
                    cmd.Parameters.Add(new OleDbParameter(OBISDetailsSEAC_DAO.Device_Id, Row.Device_Id));
                    cmd.ExecuteNonQuery();
                    // Row.AcceptChanges();
        ...
        public void UpdateOBISDetails(Configs.OBIS_DetailsRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Modified)
                {
                    OleDbCommand cmd = GetCommand(OBISDetailsSEAC_DAO.Update);
                    ///Parameters Reflecting Modification
                    cmd.Parameters.Add(new OleDbParameter(OBISDetailsSEAC_DAO.Obis_Code, Row.Obis_Code));
                    cmd.Parameters.Add(new OleDbParameter(OBISDetailsSEAC_DAO.Default_OBIS_Code, Row.Default_OBIS_Code));
                    cmd.Parameters.Add(new OleDbParameter(OBISDetailsSEAC_DAO.Device_Id, Row.Device_Id));
                    ///Parameters Before Modification
                    cmd.Parameters.Add(new OleDbParameter(OBISDetailsSEAC_DAO.IdParam + "_", Convert.ToInt32(Row["id", DataRowVersion.Original])));
                    cmd.ExecuteNonQuery();
                    //Row.AcceptChanges();
                }
                #endregion
        ...
        public void DeleteOBISDetails(Configs.OBIS_DetailsRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Deleted)
                {
                    OleDbCommand cmd = GetCommand(OBISDetailsSEAC_DAO.Delete);
                    cmd.Parameters.Add(new OleDbParameter(OBISDetailsSEAC_DAO.IdParam + "_", Convert.ToInt32(Row["id", DataRowVersion.Original])));
    ...
    #region OBISRightsGroupSEAC_DAO

    public class OBISRightsGroupSEAC_DAO : SEAC_DAO
    {
        #region Data Members
        ...
        public OBISRightsGroupSEAC_DAO(string connectionString)
            : base(connectionString)
        { }
        public OBISRightsGroupSEAC_DAO(IDbConnection connection)
            : base(connection)
        { }
        ...
        public void InsertOBISRightsGroup(Configs.Obis_Rights_GroupRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Added)
                {
                    OleDbCommand cmd = GetCommand(OBISRightsGroupSEAC_DAO.Insert);
                    cmd.Parameters.Add(new OleDbParameter(OBISRightsGroupSEAC_DAO.IdParam, Row.id));
                    cmd.Parameters.Add(new OleDbParameter(OBISRightsGroupSEAC_DAO.Group_Name, Row.Group_Name));
                    cmd.Parameters.Add(new OleDbParameter(OBISRightsGroupSEAC_DAO.Update_Rights, Row.Update_Rights));
                    //cmd.Parameters.Add(new OleDbParameter(MeterTypeInfoSEAC_DAO.FirmWareVersionParam, Row.FirmWareVersion));
                    int res = cmd.ExecuteNonQuery();
                    //Row.AcceptChanges();
                }
        ...
        public void UpdateOBISRightsGroup(Configs.Obis_Rights_GroupRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Modified)
                {
                    OleDbCommand cmd = GetCommand(OBISRightsGroupSEAC_DAO.Update);
                    ///Reflected Changes Parameters
                    cmd.Parameters.Add(new OleDbParameter(OBISRightsGroupSEAC_DAO.Group_Name, Row.Group_Name));
                    cmd.Parameters.Add(new OleDbParameter(OBISRightsGroupSEAC_DAO.Update_Rights, Row.Update_Rights));

                    /// Parameters Before Modification
                    cmd.Parameters.Add(new OleDbParameter(OBISRightsGroupSEAC_DAO.IdParam + "_", Convert.ToInt32(Row["id", DataRowVersion.Original])));
        ...
        public void DeleteOBISRightsGroup(Configs.Obis_Rights_GroupRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Deleted)
                {
                    OleDbCommand cmd = GetCommand(OBISRightsGroupSEAC_DAO.Delete);
                    cmd.Parameters.Add(new OleDbParameter(OBISRightsGroupSEAC_DAO.IdParam + "_", Convert.ToInt32(Row["id", DataRowVersion.Original])));
                    cmd.ExecuteNonQuery();
                    //Row.AcceptChanges();
                }
    ...
    public class OBISRithtsSEAC_DAO : SEAC_DAO
    {
        #region Data Members
        ...
        public OBISRithtsSEAC_DAO(string connectionString)
            : base(connectionString)
        {

        }
        public OBISRithtsSEAC_DAO(IDbConnection connection)
            : base(connection)
        { }
        ...
        public void Load_OBISRightsByGroup(Configs DataSet, Configs.Obis_Rights_GroupRow OBISRightGroupRow)
        {
            try
            {
                ...
                #endregion
                OleDbCommand SelectByGroupInfo = GetCommand(OBISRithtsSEAC_DAO.SelectByGroupInfo);
                SelectByGroupInfo.Parameters.Add(new OleDbParameter(OBISRithtsSEAC_DAO.ObisRightGroupId, OBISRightGroupRow.id));
        ...
        public long Load_MaxOBISRightId()
        {
            try
            {
                OleDbCommand Select_MaxOBISCodeId = GetCommand(OBISRithtsSEAC_DAO.SelectMaxId);
        ...
        public void InsertOBIS_Rights(Configs.OBIS_RightsRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Added)
                {
                    OleDbCommand cmd = GetCommand(OBISRithtsSEAC_DAO.Insert);
                    cmd.Parameters.Add(new OleDbParameter(OBISRithtsSEAC_DAO.IdParam, Row.id));
                    cmd.Parameters.Add(new OleDbParameter(OBISRithtsSEAC_DAO.ObisRightGroupId, Row.ObisRightGroupId));
                    cmd.Parameters.Add(new OleDbParameter(OBISRithtsSEAC_DAO.OBISIndexParam, Row.OBIS_Index));
                    cmd.Parameters.Add(new OleDbParameter(OBISRithtsSEAC_DAO.VersionParam, Row.Version));
                    cmd.ExecuteNonQuery();
                    // Row.AcceptChanges();
        ...
        public void UpdateOBIS_Rights(Configs.OBIS_RightsRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Modified)
                {
                    OleDbCommand cmd = GetCommand(OBISRithtsSEAC_DAO.Update);
                    ///Parameters Reflecting Modification
                    cmd.Parameters.Add(new OleDbParameter(OBISRithtsSEAC_DAO.ObisRightGroupId, Row.ObisRightGroupId));
                    cmd.Parameters.Add(new OleDbParameter(OBISRithtsSEAC_DAO.OBISIndexParam, Row.OBIS_Index));
                    cmd.Parameters.Add(new OleDbParameter(OBISRithtsSEAC_DAO.VersionParam, Row.Version));
                    ///Parameters Before Modification
                    cmd.Parameters.Add(new OleDbParameter(OBISRithtsSEAC_DAO.IdParam + "_", Convert.ToInt32(Row["id", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(OBISRithtsSEAC_DAO.ObisRightGroupId + "_", Convert.ToInt32(Row["ObisRightGroupId", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(OBISRithtsSEAC_DAO.OBISIndexParam + "_", Convert.ToDecimal(Row["OBIS_Index", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(OBISRithtsSEAC_DAO.VersionParam + "_", Convert.ToByte(Row["Version", DataRowVersion.Original])));
                    cmd.ExecuteNonQuery();
                    //Row.AcceptChanges();
                }
                #endregion
        ...
        public void DeleteOBIS_Rights(Configs.OBIS_RightsRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Deleted)
                {
                    OleDbCommand cmd = GetCommand(OBISRithtsSEAC_DAO.Delete);
                    cmd.Parameters.Add(new OleDbParameter(OBISRithtsSEAC_DAO.IdParam + "_", Convert.ToInt32(Row["id", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(OBISRithtsSEAC_DAO.ObisRightGroupId + "_", Convert.ToInt32(Row["ObisRightGroupId", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(OBISRithtsSEAC_DAO.OBISIndexParam + "_", Convert.ToDecimal(Row["OBIS_Index", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(OBISRithtsSEAC_DAO.VersionParam + "_", Convert.ToByte(Row["Version", DataRowVersion.Original])));
    ...
    public class RithtsSEAC_DAO : SEAC_DAO
    {
        #region Data Members
        ...
        public RithtsSEAC_DAO(string connectionString)
            : base(connectionString) { }
        public RithtsSEAC_DAO(IDbConnection connection)
            : base(connection)
        { }
        ...
        public void Load_RightsByOBISRightId(Configs DataSet, List<Configs.OBIS_RightsRow> OBISRights)
        {
            try
            {
                ...
                {
                    OleDbCommand SelectOBISRights = GetCommand(RithtsSEAC_DAO.SelectByOBISRightId);
                    SelectOBISRights.Parameters.Add(new OleDbParameter(RithtsSEAC_DAO.OBIS_RightsParam, OBISRight.id));
        ...
        public long Load_MaxOBISRightId()
        {
            try
            {
                OleDbCommand Select_MaxOBISCodeId = GetCommand(RithtsSEAC_DAO.SelectMaxId);
        ...
        public void InsertRights(Configs.RightsRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Added)
                {
                    OleDbCommand cmd = GetCommand(RithtsSEAC_DAO.Insert);
                    cmd.Parameters.Add(new OleDbParameter(RithtsSEAC_DAO.IdParam, Row.id));
                    cmd.Parameters.Add(new OleDbParameter(RithtsSEAC_DAO.TypeParam, Row.type));
                    cmd.Parameters.Add(new OleDbParameter(RithtsSEAC_DAO.SubIdParam, Row.SubId));
                    cmd.Parameters.Add(new OleDbParameter(RithtsSEAC_DAO.ValueParam, Row.value));
                    cmd.Parameters.Add(new OleDbParameter(RithtsSEAC_DAO.OBIS_RightsParam, Row.OBIS_Right_Id));
                    cmd.ExecuteNonQuery();
                    //Row.AcceptChanges();
                }
                #endregion
        ...
        public void UpdateRights(Configs.RightsRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Added)
                {
                    OleDbCommand cmd = GetCommand(RithtsSEAC_DAO.Update);
                    ...
                    cmd.Parameters.Add(new OleDbParameter(RithtsSEAC_DAO.IdParam + "-", Convert.ToInt32(Row["id", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(RithtsSEAC_DAO.TypeParam + "-", Convert.ToByte(Row["type", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(RithtsSEAC_DAO.SubIdParam + "-", Convert.ToByte(Row["SubId", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(RithtsSEAC_DAO.ValueParam + "-", Convert.ToByte(Row["value", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(RithtsSEAC_DAO.OBIS_RightsParam + "-", Convert.ToInt64(Row["OBIS_Right_Id", DataRowVersion.Original])));
        ...
        public void DeleteRights(Configs.RightsRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Deleted)
                {
                    OleDbCommand cmd = GetCommand(RithtsSEAC_DAO.Delete);
                    cmd.Parameters.Add(new OleDbParameter(RithtsSEAC_DAO.IdParam, Convert.ToInt32(Row["id", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(RithtsSEAC_DAO.TypeParam, Convert.ToByte(Row["type", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(RithtsSEAC_DAO.SubIdParam, Convert.ToByte(Row["SubId", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(RithtsSEAC_DAO.ValueParam, Convert.ToByte(Row["value", DataRowVersion.Original])));
    ...
    public class DisplayWindowSEAC_DAO : SEAC_DAO
    {
        #region Data Members

        public static readonly string Select = "Select * from [DisplayWindows] order by [id],[QuantityIndex],[SequenceId]";

        public static readonly string Insert = "INSERT INTO [DisplayWindows] ([id], [Category], [Label], [AttributeNo], [WinNumberToDisplay], [QuantityIndex], [SequenceId], [DisplayWindowsGroupId]) " +
        ...
        public DisplayWindowSEAC_DAO(string connectionString)
            : base(connectionString) { }
        public DisplayWindowSEAC_DAO(IDbConnection connection)
            : base(connection)
        { }
        ...
        public void Insert_DisplayWindow(Configs.DisplayWindowsRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Added)
                {
                    OleDbCommand cmd = GetCommand(DisplayWindowSEAC_DAO.Insert);
                    cmd.Parameters.Add(new OleDbParameter(DisplayWindowSEAC_DAO.IdParam, Row.id));
                    cmd.Parameters.Add(new OleDbParameter(DisplayWindowSEAC_DAO.LabelParam, Row.Label));
                    cmd.Parameters.Add(new OleDbParameter(DisplayWindowSEAC_DAO.CategoryParam, Row.Category));
                    cmd.Parameters.Add(new OleDbParameter(DisplayWindowSEAC_DAO.AttributeNoParam, Row.AttributeNo));
                    cmd.Parameters.Add(new OleDbParameter(DisplayWindowSEAC_DAO.WindowNumberParam, Row.WinNumberToDisplay));
                    cmd.Parameters.Add(new OleDbParameter(DisplayWindowSEAC_DAO.OBISIndexParam, Row.QuantityIndex));
                    cmd.Parameters.Add(new OleDbParameter(DisplayWindowSEAC_DAO.SequenceIdParam, Row.SequenceId));
                    cmd.Parameters.Add(new OleDbParameter(DisplayWindowSEAC_DAO.DisplayWindowsGroupIdParam, Row.DisplayWindowsGroupId));
                    int res = cmd.ExecuteNonQuery();
                    // Row.AcceptChanges();
                }
                #endregion
        ...
        public void Update_DisplayWindow(Configs.DisplayWindowsRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Modified)
                {
                    OleDbCommand cmd = GetCommand(DisplayWindowSEAC_DAO.Update);
                    // Parameters Reflecting Changes
                    cmd.Parameters.Add(new OleDbParameter(DisplayWindowSEAC_DAO.CategoryParam, Row.Category));
                    cmd.Parameters.Add(new OleDbParameter(DisplayWindowSEAC_DAO.LabelParam, Row.Label));
                    cmd.Parameters.Add(new OleDbParameter(DisplayWindowSEAC_DAO.AttributeNoParam, Row.AttributeNo));
                    ...
                    cmd.Parameters.Add(new OleDbParameter(DisplayWindowSEAC_DAO.IdParam + "_", Convert.ToInt32(Row["id", DataRowVersion.Original])));
                    // cmd.Parameters.Add(new OleDbParameter(DisplayWindowSEAC_DAO.LabelParam + "_", Convert.ToString(Row["Label", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(DisplayWindowSEAC_DAO.CategoryParam + "_", Convert.ToByte(Row["Category", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(DisplayWindowSEAC_DAO.AttributeNoParam + "_", Convert.ToByte(Row["AttributeNo", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(DisplayWindowSEAC_DAO.WindowNumberParam + "_", Convert.ToUInt32(Row["WinNumberToDisplay", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(DisplayWindowSEAC_DAO.OBISIndexParam + "_", Convert.ToUInt64(Row["QuantityIndex", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(DisplayWindowSEAC_DAO.SequenceIdParam + "_", Convert.ToUInt32(Row["SequenceId", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(DisplayWindowSEAC_DAO.DisplayWindowsGroupIdParam + "_", Convert.ToUInt32(Row["DisplayWindowsGroupId", DataRowVersion.Original])));
        ...
        public void Delete_DisplayWindow(Configs.DisplayWindowsRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Deleted)
                {
                    OleDbCommand cmd = GetCommand(DisplayWindowSEAC_DAO.Delete);
                    cmd.Parameters.Add(new OleDbParameter(DisplayWindowSEAC_DAO.IdParam + "_", Convert.ToInt32(Row["id", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(DisplayWindowSEAC_DAO.CategoryParam + "_", Convert.ToByte(Row["Category", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(DisplayWindowSEAC_DAO.AttributeNoParam + "_", Convert.ToByte(Row["AttributeNo", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(DisplayWindowSEAC_DAO.WindowNumberParam + "_", Convert.ToUInt32(Row["WinNumberToDisplay", DataRowVersion.Original])));
    ...
    public class DisplayWindowsGroupSEAC_DAO : SEAC_DAO
    {
        #region Data Members
        ...
        public DisplayWindowsGroupSEAC_DAO(string connectionString)
            : base(connectionString)
        { }
        public DisplayWindowsGroupSEAC_DAO(IDbConnection connection)
            : base(connection)
        { }
        ...
        public void InsertDisplayWindowsGroup(Configs.DisplayWindows_GroupRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Added)
                {
                    OleDbCommand cmd = GetCommand(DisplayWindowsGroupSEAC_DAO.Insert);
                    cmd.Parameters.Add(new OleDbParameter(DisplayWindowsGroupSEAC_DAO.IdParam, Row.id));
                    cmd.Parameters.Add(new OleDbParameter(DisplayWindowsGroupSEAC_DAO.DWGroupName, Row.Dw_Group_Name));
                    int res = cmd.ExecuteNonQuery();
                    //Row.AcceptChanges();
                }
                #endregion
        ...
        public void UpdateDisplayWindowsGroup(Configs.DisplayWindows_GroupRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Modified)
                {
                    OleDbCommand cmd = GetCommand(DisplayWindowsGroupSEAC_DAO.Update);
                    ///Reflected Changes Parameters
                    cmd.Parameters.Add(new OleDbParameter(DisplayWindowsGroupSEAC_DAO.DWGroupName, Row.Dw_Group_Name));
                    ///Before Changes Parameters
                    cmd.Parameters.Add(new OleDbParameter(DisplayWindowsGroupSEAC_DAO.IdParam + "_", Convert.ToInt32(Row["id", DataRowVersion.Original])));
        ...
        public void DeleteDisplayWindowsGroup(Configs.DisplayWindows_GroupRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Deleted)
                {
                    OleDbCommand cmd = GetCommand(DisplayWindowsGroupSEAC_DAO.Delete);
                    cmd.Parameters.Add(new OleDbParameter(DisplayWindowsGroupSEAC_DAO.IdParam + "_", Convert.ToInt32(Row["id", DataRowVersion.Original])));
                    cmd.ExecuteNonQuery();
                    /// Row.AcceptChanges();
                }
    ...
    public class LoadProfileSEAC_DAO : SEAC_DAO
    {
        #region Data Members
        ...
        public LoadProfileSEAC_DAO(string connectionString)
            : base(connectionString) { }
        public LoadProfileSEAC_DAO(IDbConnection connection)
            : base(connection)
        { }
        ...
        public void Insert_LoadProfiles(Configs.LoadProfileChannelsRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Added)
                {
                    OleDbCommand cmd = GetCommand(LoadProfileSEAC_DAO.Insert);
                    cmd.Parameters.Add(new OleDbParameter(LoadProfileSEAC_DAO.IdParam, Row.id));
                    cmd.Parameters.Add(new OleDbParameter(LoadProfileSEAC_DAO.LabelParam, Row.Label));
                    cmd.Parameters.Add(new OleDbParameter(LoadProfileSEAC_DAO.OBISIndexParam, Row.QuantityIndex));
                    cmd.Parameters.Add(new OleDbParameter(LoadProfileSEAC_DAO.AttributeNoParam, Row.AttributeNo));
                    cmd.Parameters.Add(new OleDbParameter(LoadProfileSEAC_DAO.MultiplierParam, Row.Multiplier));
                    cmd.Parameters.Add(new OleDbParameter(LoadProfileSEAC_DAO.SequenceIdParam, Row.SequenceId));
                    cmd.Parameters.Add(new OleDbParameter(LoadProfileSEAC_DAO.FormatSpecifierParam, Row.FormatSpecifier));
                    cmd.Parameters.Add(new OleDbParameter(LoadProfileSEAC_DAO.UnitParam, Row.Unit));
                    cmd.Parameters.Add(new OleDbParameter(LoadProfileSEAC_DAO.LoadProfileGroupIdParam, Row.LoadProfileGroupId));
                    int res = cmd.ExecuteNonQuery();
                    // Row.AcceptChanges();
                }
        ...
        public void Update_LoadProfiles(Configs.LoadProfileChannelsRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Modified)
                {
                    OleDbCommand cmd = GetCommand(LoadProfileSEAC_DAO.Update);
                    ///Parameters Reflecting Changes
                    cmd.Parameters.Add(new OleDbParameter(LoadProfileSEAC_DAO.LabelParam, Row.Label));
                    cmd.Parameters.Add(new OleDbParameter(LoadProfileSEAC_DAO.OBISIndexParam, Row.QuantityIndex));
                    cmd.Parameters.Add(new OleDbParameter(LoadProfileSEAC_DAO.AttributeNoParam, Row.AttributeNo));
                    ...
                    cmd.Parameters.Add(new OleDbParameter(LoadProfileSEAC_DAO.LoadProfileGroupIdParam, Row.LoadProfileGroupId));
                    ///Parameters Before Changes
                    cmd.Parameters.Add(new OleDbParameter(LoadProfileSEAC_DAO.IdParam + "_", Convert.ToInt32(Row["id", DataRowVersion.Original])));
                    //cmd.Parameters.Add(new OleDbParameter(LoadProfileSEAC_DAO.MultiplierParam + "_", Convert.ToInt32(Row["AttributeNo", DataRowVersion.Original])));
                    //cmd.Parameters.Add(new OleDbParameter(LoadProfileSEAC_DAO.AttributeNoParam + "_", Convert.ToByte(Row["AttributeNo", DataRowVersion.Original])));
                    //cmd.Parameters.Add(new OleDbParameter(LoadProfileSEAC_DAO.OBISIndexParam + "_", Convert.ToUInt64(Row["QuantityIndex", DataRowVersion.Original])));
                    //cmd.Parameters.Add(new OleDbParameter(LoadProfileSEAC_DAO.SequenceIdParam + "_", Convert.ToUInt32(Row["SequenceId", DataRowVersion.Original])));
                    //cmd.Parameters.Add(new OleDbParameter(LoadProfileSEAC_DAO.FormatSpecifierParam + "_", Convert.ToString(Row["FormatSpecifier", DataRowVersion.Original])));
                    //cmd.Parameters.Add(new OleDbParameter(LoadProfileSEAC_DAO.UnitParam + "_", Convert.ToString(Row["Unit", DataRowVersion.Original])));
                    //cmd.Parameters.Add(new OleDbParameter(LoadProfileSEAC_DAO.LoadProfileGroupIdParam + "_", Convert.ToInt32(Row["LoadProfileGroupId", DataRowVersion.Original])));
                    int res = cmd.ExecuteNonQuery();
                    //Row.AcceptChanges();
                }
                #endregion
        ...
        public void Delete_LoadProfiles(Configs.LoadProfileChannelsRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Deleted)
                {
                    OleDbCommand cmd = GetCommand(LoadProfileSEAC_DAO.Delete);
                    cmd.Parameters.Add(new OleDbParameter(LoadProfileSEAC_DAO.IdParam + "_", Convert.ToInt32(Row["id", DataRowVersion.Original])));
                    //cmd.Parameters.Add(new OleDbParameter(LoadProfileSEAC_DAO.MultiplierParam + "_", Convert.ToInt32(Row["AttributeNo", DataRowVersion.Original])));
                    //cmd.Parameters.Add(new OleDbParameter(LoadProfileSEAC_DAO.AttributeNoParam + "_", Convert.ToByte(Row["AttributeNo", DataRowVersion.Original])));
                    //cmd.Parameters.Add(new OleDbParameter(LoadProfileSEAC_DAO.OBISIndexParam + "_", Convert.ToUInt64(Row["QuantityIndex", DataRowVersion.Original])));
    ...
    public class LoadProfileGroupSEAC_DAO : SEAC_DAO
    {
        #region Data Members
        ...
        public LoadProfileGroupSEAC_DAO(string connectionString)
            : base(connectionString)
        { }
        public LoadProfileGroupSEAC_DAO(IDbConnection connection)
            : base(connection)
        { }
        ...
        public void InsertLoadProfileGroup(Configs.LoadProfile_GroupRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Added)
                {
                    OleDbCommand cmd = GetCommand(LoadProfileGroupSEAC_DAO.Insert);
                    cmd.Parameters.Add(new OleDbParameter(LoadProfileGroupSEAC_DAO.IdParam, Row.id));
                    cmd.Parameters.Add(new OleDbParameter(LoadProfileGroupSEAC_DAO.LPGroupName, Row.LoadProfile_Group_Name));
                    int res = cmd.ExecuteNonQuery();
                    //Row.AcceptChanges();
                }
                #endregion
        ...
        public void UpdateLoadProfileGroup(Configs.LoadProfile_GroupRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Modified)
                {
                    OleDbCommand cmd = GetCommand(LoadProfileGroupSEAC_DAO.Update);
                    ///Reflected Changes Parameters
                    cmd.Parameters.Add(new OleDbParameter(LoadProfileGroupSEAC_DAO.LPGroupName, Row.LoadProfile_Group_Name));
                    ///Before Changes Parameters
                    cmd.Parameters.Add(new OleDbParameter(LoadProfileGroupSEAC_DAO.IdParam + "_", Convert.ToInt32(Row["id", DataRowVersion.Original])));
        ...
        public void DeleteLoadProfileGroup(Configs.LoadProfile_GroupRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Deleted)
                {
                    OleDbCommand cmd = GetCommand(LoadProfileGroupSEAC_DAO.Delete);
                    cmd.Parameters.Add(new OleDbParameter(LoadProfileGroupSEAC_DAO.IdParam + "_", Convert.ToInt32(Row["id", DataRowVersion.Original])));
                    cmd.ExecuteNonQuery();
                    //Row.AcceptChanges();
                }
    ...
    public class BillItemSEAC_DAO : SEAC_DAO
    {
        #region Data Members

        public static readonly string Select = "Select * from [BillingItems] order by [id],[BillItemGroupId]";
        ...
        public BillItemSEAC_DAO(string connectionString)
            : base(connectionString) { }
        public BillItemSEAC_DAO(IDbConnection connection)
            : base(connection)
        { }
        ...
        public void Insert_BillItem(Configs.BillingItemsRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Added)
                {
                    OleDbCommand cmd = GetCommand(BillItemSEAC_DAO.Insert);
                    cmd.Parameters.Add(new OleDbParameter(BillItemSEAC_DAO.IdParam, Row.id));
                    cmd.Parameters.Add(new OleDbParameter(BillItemSEAC_DAO.LabelParam, Row.Label));
                    cmd.Parameters.Add(new OleDbParameter(BillItemSEAC_DAO.FormatSpecifierParam, Row.FormatSpecifier));
                    cmd.Parameters.Add(new OleDbParameter(BillItemSEAC_DAO.UnitParam, Row.Unit));
                    cmd.Parameters.Add(new OleDbParameter(BillItemSEAC_DAO.MultiplierParam, Row.Multiplier));
                    cmd.Parameters.Add(new OleDbParameter(BillItemSEAC_DAO.SequenceIdParam, Row.SequenceId));
                    cmd.Parameters.Add(new OleDbParameter(BillItemSEAC_DAO.BillItemGroupIdParam, Row.BillItemGroupId));
                    int res = cmd.ExecuteNonQuery();
                    //Row.AcceptChanges();
                }
                #endregion
        ...
        public void Update_BillItem(Configs.BillingItemsRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Modified)
                {
                    OleDbCommand cmd = GetCommand(BillItemSEAC_DAO.Update);
                    ...
                    cmd.Parameters.Add(new OleDbParameter(BillItemSEAC_DAO.IdParam + "_", Convert.ToInt32(Row["id", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(BillItemSEAC_DAO.LabelParam + "_", Convert.ToString(Row["Label", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(BillItemSEAC_DAO.FormatSpecifierParam + "_", Convert.ToString(Row["FormatSpecifier", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(BillItemSEAC_DAO.UnitParam + "_", Convert.ToString(Row["Unit", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(BillItemSEAC_DAO.MultiplierParam + "_", Convert.ToInt32(Row["Multiplier", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(BillItemSEAC_DAO.SequenceIdParam + "_", Convert.ToInt32(Row["SequenceId", DataRowVersion.Original])));

                    cmd.Parameters.Add(new OleDbParameter(BillItemSEAC_DAO.BillItemGroupIdParam + "_", Convert.ToUInt32(Row["BillItemGroupId", DataRowVersion.Original])));
        ...
        public void Delete_BillItem(Configs.BillingItemsRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Deleted)
                {
                    OleDbCommand cmd = GetCommand(BillItemSEAC_DAO.Delete);
                    cmd.Parameters.Add(new OleDbParameter(BillItemSEAC_DAO.IdParam + "_", Convert.ToInt32(Row["id", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(BillItemSEAC_DAO.LabelParam + "_", Convert.ToString(Row["Label", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(BillItemSEAC_DAO.FormatSpecifierParam + "_", Convert.ToString(Row["FormatSpecifier", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(BillItemSEAC_DAO.UnitParam + "_", Convert.ToString(Row["Unit", DataRowVersion.Original])));
    ...
    public class BillingItemGroupSEAC_DAO : SEAC_DAO
    {
        #region Data Members
        ...
        public BillingItemGroupSEAC_DAO(string connectionString)
            : base(connectionString)
        { }
        public BillingItemGroupSEAC_DAO(IDbConnection connection)
            : base(connection)
        { }
        ...
        public void InsertBillingItemGroup(Configs.BillingItem_GroupRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Added)
                {
                    OleDbCommand cmd = GetCommand(BillingItemGroupSEAC_DAO.Insert);
                    cmd.Parameters.Add(new OleDbParameter(BillingItemGroupSEAC_DAO.IdParam, Row.id));
                    cmd.Parameters.Add(new OleDbParameter(BillingItemGroupSEAC_DAO.BIGroupName, Row.BillingItem_Group_Name));
                    int res = cmd.ExecuteNonQuery();
                    //Row.AcceptChanges();
                }
                #endregion
        ...
        public void UpdateBillingItemGroup(Configs.BillingItem_GroupRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Modified)
                {
                    OleDbCommand cmd = GetCommand(BillingItemGroupSEAC_DAO.Update);
                    ///Reflected Changes Parameters
                    cmd.Parameters.Add(new OleDbParameter(BillingItemGroupSEAC_DAO.BIGroupName, Row.BillingItem_Group_Name));
                    ///Before Changes Parameters
                    cmd.Parameters.Add(new OleDbParameter(BillingItemGroupSEAC_DAO.IdParam + "_", Convert.ToInt32(Row["id", DataRowVersion.Original])));
        ...
        public void DeleteBillingItemGroup(Configs.BillingItem_GroupRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Deleted)
                {
                    OleDbCommand cmd = GetCommand(BillingItemGroupSEAC_DAO.Delete);
                    cmd.Parameters.Add(new OleDbParameter(BillingItemGroupSEAC_DAO.IdParam + "_", Convert.ToInt32(Row["id", DataRowVersion.Original])));
                    cmd.ExecuteNonQuery();
                    /// Row.AcceptChanges();
                }
    ...
    public class BillTariffSEAC_DAO : SEAC_DAO
    {
        #region Data Members
        ...
        public BillTariffSEAC_DAO(string connectionString)
            : base(connectionString) { }
        public BillTariffSEAC_DAO(IDbConnection connection)
            : base(connection)
        { }
        ...
        public void Insert_BillTariff(Configs.BillTariffQuantityRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Added)
                {
                    OleDbCommand cmd = GetCommand(BillTariffSEAC_DAO.Insert);
                    cmd.Parameters.Add(new OleDbParameter(BillTariffSEAC_DAO.BillIdParam, Row.BillItemId));
                    cmd.Parameters.Add(new OleDbParameter(BillTariffSEAC_DAO.OBISIndexParam, Row.OBIS_Index));
                    cmd.Parameters.Add(new OleDbParameter(BillTariffSEAC_DAO.SequenceIdParam, Row.SequenceId));
                    int res = cmd.ExecuteNonQuery();
                    //Row.AcceptChanges();
                }
                #endregion
        ...
        public void Update_BillTariff(Configs.BillTariffQuantityRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Modified)
                {
                    OleDbCommand cmd = GetCommand(BillTariffSEAC_DAO.Update);
                    ///Parameters Reflecting Changes
                    cmd.Parameters.Add(new OleDbParameter(BillTariffSEAC_DAO.SequenceIdParam, Row.SequenceId));
                    cmd.Parameters.Add(new OleDbParameter(BillTariffSEAC_DAO.OBISIndexParam, Row.OBIS_Index));
                    ///Parameter Before Changes
                    cmd.Parameters.Add(new OleDbParameter(BillTariffSEAC_DAO.BillIdParam + "_", Convert.ToInt32(Row["BillItemId", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(BillTariffSEAC_DAO.OBISIndexParam + "_", Convert.ToUInt64(Row["OBIS_Index", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(BillTariffSEAC_DAO.SequenceIdParam + "_", Convert.ToInt32(Row["SequenceId", DataRowVersion.Original])));
        ...
        public void Delete_BillTariff(Configs.BillTariffQuantityRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Deleted)
                {
                    OleDbCommand cmd = GetCommand(BillTariffSEAC_DAO.Delete);
                    cmd.Parameters.Add(new OleDbParameter(BillTariffSEAC_DAO.BillIdParam + "_", Convert.ToInt32(Row["BillItemId", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(BillTariffSEAC_DAO.OBISIndexParam + "_", Convert.ToUInt64(Row["OBIS_Index", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(BillTariffSEAC_DAO.SequenceIdParam + "_", Convert.ToInt32(Row["SequenceId", DataRowVersion.Original])));
    ...
    public class EventInfoSEAC_DAO : SEAC_DAO
    {
        #region Data Members
        ...
        public EventInfoSEAC_DAO(string connectionString)
            : base(connectionString) { }
        public EventInfoSEAC_DAO(IDbConnection connection)
            : base(connection)
        { }
        ...
        public void Insert_EventProfileInfo(Configs.EventInfoRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Added)
                {
                    OleDbCommand cmd = GetCommand(EventInfoSEAC_DAO.Insert);

                    cmd.Parameters.Add(new OleDbParameter(EventInfoSEAC_DAO.IdParam, Row.id));
                    cmd.Parameters.Add(new OleDbParameter(EventInfoSEAC_DAO.EventCodeParam, Row.EventCode));
                    cmd.Parameters.Add(new OleDbParameter(EventInfoSEAC_DAO.EventNoParam, Row.EventNo));
                    cmd.Parameters.Add(new OleDbParameter(EventInfoSEAC_DAO.LabelParam, Row.Label));
                    cmd.Parameters.Add(new OleDbParameter(EventInfoSEAC_DAO.MaxEventCountParam, Row.MaxEventCount));
                    cmd.Parameters.Add(new OleDbParameter(EventInfoSEAC_DAO.ConfigParam, Row.EventGroupId));

                    cmd.Parameters.Add(new OleDbParameter(EventInfoSEAC_DAO.CautionNumberParam, Row.IsNull("CautionNumber") ?
                                      DBNull.Value : (object)Row.CautionNumber) { OleDbType = OleDbType.Integer });
                    cmd.Parameters.Add(new OleDbParameter(EventInfoSEAC_DAO.FlashTimeParam, Row.IsNull("FlashTime") ?
        ...
        public void Update_EventProfileInfo(Configs.EventInfoRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Modified)
                {
                    OleDbCommand cmd = GetCommand(EventInfoSEAC_DAO.Update);
                    // Parameters Reflecting Changes
                    cmd.Parameters.Add(new OleDbParameter(EventInfoSEAC_DAO.EventNoParam, Row.EventNo));
                    cmd.Parameters.Add(new OleDbParameter(EventInfoSEAC_DAO.EventCodeParam, Row.EventCode));
                    cmd.Parameters.Add(new OleDbParameter(EventInfoSEAC_DAO.LabelParam, Row.Label));
                    ...
                    // Parameters Before Changes
                    cmd.Parameters.Add(new OleDbParameter(EventInfoSEAC_DAO.IdParam + "_", Convert.ToInt32(Row["id", DataRowVersion.Original])));
                    cmd.Parameters.Add(new OleDbParameter(EventInfoSEAC_DAO.EventCodeParam + "_", Convert.ToInt32(Row["EventCode", DataRowVersion.Original])));
        ...
        public void Delete_EventProfileInfo(Configs.EventInfoRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Deleted)
                {
                    OleDbCommand cmd = GetCommand(EventInfoSEAC_DAO.Delete);
    ...
    public class EventLogsSEAC_DAO : SEAC_DAO
    {
        #region Data Members
        ...
        public EventLogsSEAC_DAO(string connectionString)
            : base(connectionString) { }
        public EventLogsSEAC_DAO(IDbConnection connection)
            : base(connection)
        { }
        ...
        public void Insert_EventLog(Configs.EventLogsRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Added)
                {
                    OleDbCommand cmd = GetCommand(EventLogsSEAC_DAO.Insert);
                    cmd.Parameters.Add(new OleDbParameter(EventLogsSEAC_DAO.IdParam, Row.id));
                    cmd.Parameters.Add(new OleDbParameter(EventLogsSEAC_DAO.EventLogOBISIndexParam, Row.EventLogIndex));
                    cmd.Parameters.Add(new OleDbParameter(EventLogsSEAC_DAO.EventCounterOBISIndexParam, Row.EventCounterIndex));
                    cmd.Parameters.Add(new OleDbParameter(EventLogsSEAC_DAO.ConfigParam, Row.EventGroupId));
                    int res = cmd.ExecuteNonQuery();
                    /// Row.AcceptChanges();
                }
        ...
        public void Update_EventLog(Configs.EventLogsRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Modified)
                {
                    OleDbCommand cmd = GetCommand(EventLogsSEAC_DAO.Update);
                    ///Parameters Reflecting Changes
                    cmd.Parameters.Add(new OleDbParameter(EventLogsSEAC_DAO.EventLogOBISIndexParam, Row.EventLogIndex));
                    cmd.Parameters.Add(new OleDbParameter(EventLogsSEAC_DAO.EventCounterOBISIndexParam, Row.EventCounterIndex));
                    cmd.Parameters.Add(new OleDbParameter(EventLogsSEAC_DAO.ConfigParam, Row.EventGroupId));
                    ...
                    /// Parameters Before Changes
                    cmd.Parameters.Add(new OleDbParameter(EventLogsSEAC_DAO.IdParam + "_", Convert.ToInt32(Row["id", DataRowVersion.Original])));

                    /// cmd.Parameters.Add(new OleDbParameter(EventLogsSEAC_DAO.EventLogOBISIndexParam + "_", Convert.ToUInt64(Row["EventLogIndex", DataRowVersion.Original])));
                    /// cmd.Parameters.Add(new OleDbParameter(EventLogsSEAC_DAO.EventCounterOBISIndexParam + "_", Convert.ToUInt64(Row["EventCounterIndex", DataRowVersion.Original])));
                    /// cmd.Parameters.Add(new OleDbParameter(EventLogsSEAC_DAO.ConfigParam + "_", Convert.ToInt32(Row["ConfigId", DataRowVersion.Original])));
        ...
        public void Delete_EventLog(Configs.EventLogsRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Deleted)
                {
                    OleDbCommand cmd = GetCommand(EventLogsSEAC_DAO.Delete);
                    cmd.Parameters.Add(new OleDbParameter(EventLogsSEAC_DAO.IdParam + "_", Convert.ToInt32(Row["id", DataRowVersion.Original])));
                    int res = cmd.ExecuteNonQuery();
                    /// Row.AcceptChanges();
                }
    ...
    public class EventsGroupSEAC_DAO : SEAC_DAO
    {
        #region Data Members
        ...
        public EventsGroupSEAC_DAO(string connectionString)
            : base(connectionString)
        { }
        public EventsGroupSEAC_DAO(IDbConnection connection)
            : base(connection)
        { }
        ...
        public void InsertEventsGroup(Configs.Events_GroupRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Added)
                {
                    OleDbCommand cmd = GetCommand(EventsGroupSEAC_DAO.Insert);
                    cmd.Parameters.Add(new OleDbParameter(EventsGroupSEAC_DAO.IdParam, Row.id));
                    cmd.Parameters.Add(new OleDbParameter(EventsGroupSEAC_DAO.EVGroupName, Row.Events_group_Name));
                    int res = cmd.ExecuteNonQuery();
                    //Row.AcceptChanges();
                }
                #endregion
        ...
        public void UpdateEventsGroup(Configs.Events_GroupRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Modified)
                {
                    OleDbCommand cmd = GetCommand(EventsGroupSEAC_DAO.Update);
                    /// Reflected Changes Parameters
                    cmd.Parameters.Add(new OleDbParameter(EventsGroupSEAC_DAO.EVGroupName, Row.Events_group_Name));
                    /// Before Changes Parameters
                    cmd.Parameters.Add(new OleDbParameter(EventsGroupSEAC_DAO.IdParam + "_", Convert.ToInt32(Row["id", DataRowVersion.Original])));
        ...
        public void DeleteEventsGroup(Configs.Events_GroupRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Deleted)
                {
                    OleDbCommand cmd = GetCommand(EventsGroupSEAC_DAO.Delete);
                    cmd.Parameters.Add(new OleDbParameter(EventsGroupSEAC_DAO.IdParam + "_", Convert.ToInt32(Row["id", DataRowVersion.Original])));
                    cmd.ExecuteNonQuery();
                    /// Row.AcceptChanges();
                }
    ...
    public class StatusWordSEAC_DAO : SEAC_DAO
    {
        #region Data Members
        ...
        public StatusWordSEAC_DAO(string connectionString)
            : base(connectionString)
        { }
        public StatusWordSEAC_DAO(IDbConnection connection)
            : base(connection)
        { }
        ...
        public void InsertStatusWord(Configs.Status_WordRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Added)
                {
                    OleDbCommand cmd = GetCommand(StatusWordSEAC_DAO.Insert);
                    cmd.Parameters.Add(new OleDbParameter(StatusWordSEAC_DAO.Code, Row.Code));
                    cmd.Parameters.Add(new OleDbParameter(StatusWordSEAC_DAO.Name, Row.Name));
                    int res = cmd.ExecuteNonQuery();
                    //Row.AcceptChanges();
                }
                #endregion
        ...
        public void UpdateStatusWord(Configs.Status_WordRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Modified)
                {
                    OleDbCommand cmd = GetCommand(StatusWordSEAC_DAO.Update);
                    /// Reflected Changes Parameters
                    cmd.Parameters.Add(new OleDbParameter(StatusWordSEAC_DAO.Name, Row.Name));
                    /// Before Changes Parameters
                    cmd.Parameters.Add(new OleDbParameter(StatusWordSEAC_DAO.Code + "_", Convert.ToInt32(Row["Code", DataRowVersion.Original])));
        ...
        public void DeleteStatusWord(Configs.Status_WordRow Row)
        {
            try
            {
                ...
                if (Row.RowState == DataRowState.Deleted)
                {
                    OleDbCommand cmd = GetCommand(StatusWordSEAC_DAO.Delete);
                    cmd.Parameters.Add(new OleDbParameter(StatusWordSEAC_DAO.Code + "_", Convert.ToInt32(Row["Code", DataRowVersion.Original])));
                    cmd.ExecuteNonQuery();
                    /// Row.AcceptChanges();
                }
