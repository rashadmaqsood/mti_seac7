...
namespace SharedCode.TCP_Communication
{
    public class SMS_Params
    {
        ...
        public byte[] EncodePacket()
        {
            ...
            Encoded_byte_array = Common_PCL.Append_to_End(Encoded_byte_array, EncodeFlags());
            Encoded_byte_array = Common_PCL.Append_to_End(Encoded_byte_array, EncodePassword());
            Encoded_byte_array = Common_PCL.Append_to_End(Encoded_byte_array, HDLC_TCP);
            Encoded_byte_array = Common_PCL.Append_to_End(Encoded_byte_array, TCP_UDP);
            Encoded_byte_array = Common_PCL.Append_to_End(Encoded_byte_array, EncodeIP(IP));
            Encoded_byte_array = Common_PCL.Append_to_End(Encoded_byte_array, EncodeIP_Port(IP_Port));
