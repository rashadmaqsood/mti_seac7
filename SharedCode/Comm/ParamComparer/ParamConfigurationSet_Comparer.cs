...
namespace comm
{
    public class ParamConfigurationSet_Comparer : EqualityComparer<ParamConfigurationSet>
    {
        ...
        public override bool Equals(ParamConfigurationSet Obj_A, ParamConfigurationSet Obj_B)
        {
            ...
            //Compare ParamLoadProfileChannelInfo_2   //Azeem
            try
            {
                isMatch = false;
                Comparision_Failed = Params.ParamLoadProfileChannelInfo_2;
                LoadProfileChannelInfo_PrgChannel_Comparer LP_Comparer = new LoadProfileChannelInfo_PrgChannel_Comparer();

                //Reference Match
                isMatch = Obj_A.ParamLoadProfileChannelInfo_2 == Obj_B.ParamLoadProfileChannelInfo_2;

                //Compare Count
                isMatch = Obj_A.ParamLoadProfileChannelInfo_2.Count == Obj_B.ParamLoadProfileChannelInfo_2.Count;
                ...
                if (isMatch)
                {
                    ...
                    //Compare Each Channel
                    //Compare LoadProfile Period
                    for (int index = 0; isMatch && index < Obj_A.ParamLoadProfileChannelInfo_2.Count &&
                                       index < Obj_B.ParamLoadProfileChannelInfo_2.Count; index++)
                    {
                        Ch_Info_A = Obj_A.ParamLoadProfileChannelInfo_2[index];
                        Ch_Info_B = Obj_B.ParamLoadProfileChannelInfo_2[index];
