...
namespace SharedCode.Comm.Param
{
    ...
    public class Param_Monitoring_Time : ISerializable, ICloneable,IParam
    {
        ...
        [XmlIgnore()]
        public bool WriteReversePolarity { get; set; }
        [XmlIgnore()]
        ...
        [XmlIgnore()]
        public bool WriteCTFail { get; set; }
        [XmlIgnore()]
        ...
        [XmlIgnore()]
        public bool WritePTFail { get; set; }
        [XmlIgnore()]
        ...
        [XmlIgnore()]
        public bool WriteOverCurrent { get; set; }
        [XmlIgnore()]
        ...
        [XmlIgnore()]
        public bool WriteOverLoad { get; set; }
        [XmlIgnore()]
        ...
        [XmlIgnore()]
        public bool WritePowerFail { get; set; }
        [XmlIgnore()]
        ...
        [XmlIgnore()]
        public bool WritePhaseFail { get; set; }
        [XmlIgnore()]
        ...
        [XmlIgnore()]
        public bool WritePhaseSequence { get; set; }
        [XmlIgnore()]
        ...
        [XmlIgnore()]
        public bool WritePowerUPDelay { get; set; }
        [XmlIgnore()]
        ...
        [XmlIgnore()]
        public bool WritePowerUpDelayEnergyRecording { get; set; }
        [XmlIgnore()]
        ...
        [XmlIgnore()]
        public bool WritePowerUpDelayEarth { get; set; }
        [XmlIgnore()]
        ...
        [XmlIgnore()]
        public bool WriteEarth { get; set; }
        [XmlIgnore()]
        ...
        [XmlIgnore()]
        public bool WriteHALLSensor { get; set; }
        [XmlIgnore()]
        ...
        [XmlIgnore()]
        public bool WriteContactorFailure { get; set; }
        [XmlIgnore()]
        public TimeSpan ContactorFailure
        {
            get { return GetMonitorTime(MonitoringTimeItem.Contactor_failure); }
            set { SetMonitorTime(MonitoringTimeItem.Contactor_failure, value); }
        }
        #endregion

        #region Getter/Setter Functions

        public TimeSpan GetMonitorTime(MonitoringTimeItem Item)
        {
        ...
        public void SetMonitorTime(MonitoringTimeItem Item, TimeSpan value)
        {
            try
            {
        ...
        public Base_Class Encode_Contactor_Failure(GetSAPEntry CommObjectGetter)
        {
            Class_3 ContactorFailure_MT = (Class_3)EncodeMonitoringTimeParam(CommObjectGetter, Get_Index.CONTACTOR_FAILURE_MONITORING_TIME, ContactorFailure);
            return ContactorFailure_MT;
        }
        ...
        public void Decode_Contactor_Failure(Base_Class arg)
        {
            try
            {
                Class_3 Contactor_Failure_MT = (Class_3)arg;
                ContactorFailure = UpdateMTObject(Convert.ToDouble(Contactor_Failure_MT.Value));
            }
            catch
            {
                throw;
        ...
        public Base_Class Encode_HALL_Sensor(GetSAPEntry CommObjectGetter)
        {
            ...
            //Class_3 MonitoringTime_HALL_Sensorl_MT = (Class_3)CommObjectGetter.Invoke(Get_Index.MonitoringTime_HALL_Sensor);
            //MonitoringTime_HALL_Sensorl_MT.EncodingAttribute = 2;
            //MonitoringTime_HALL_Sensorl_MT.EncodingType = DataTypes._A06_double_long_unsigned;
            //MonitoringTime_HALL_Sensorl_MT.Value = SET_MT(HALLSensor);
            //return MonitoringTime_HALL_Sensorl_MT;
        }
        ...
        public void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            foreach (MonitoringTimeItem item in val_Array)
            {
                ...
                info.AddValue(Key, date_Now.Add(MT_Val));
            }
        ...
        public object Clone()
        {
            ...
            {
                throw new Exception("Error occurred while Clone Param_MonitoringTime", ex);
            }
        }
    }
}
