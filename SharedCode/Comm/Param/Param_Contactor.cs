...
namespace SharedCode.Comm.Param
{
    ...
    public class Param_Contactor : ICustomStructure, ICloneable,IParam
    {
        #region Data Members
        ...
        public byte RAW_Flags_2
        {
            get
            {
                ...
                Flags |= (PhaseFail_Flag_2) ? (byte)0x04 : (byte)0x00;
            ...
            set
            {
                ...
                PhaseFail_Flag_2 = ((Flags & 0x04) > 0) ? true : false;
        ...
        public bool WriteContactorParam { get; set; }

        #endregion

        public Param_Contactor() 
        {
            WriteContactorParam = false;
        }
        ...
        public virtual void Decode_Data(byte[] Data, ref int array_traverse, int length)
        {
            try
            {
                ...
                //  this.Control_Mode = Convert.ToByte(BasicEncodeDecode.Intelligent_Date_Decoder(ref Data, ref array_traverse));
    ...
    public class Param_ContactorExt : Param_Contactor,IParam
    {
        #region Data_Members
