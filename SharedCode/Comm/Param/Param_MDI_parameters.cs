...
namespace SharedCode.Comm.Param
{
    ...
    public class Param_MDI_parameters:IParam, ICloneable
    {
        ...
        {
            Min_Time_Unit = 0;
            Auto_reset_date = new StDateTime();
        }

        #region Encoders & Deocoder
        ...
        {
            Class_5 MDI_Params_CommObj = (Class_5)CommObjectGetter.Invoke(Get_Index.DEMAND_ALL); //DEMAND_ACTIVE_IMPORT);
        ...
        {
            if ((MDI_Interval_CommObj.INDEX == Get_Index.DEMAND_ALL || MDI_Interval_CommObj.INDEX == Get_Index.DEMAND_ACTIVE_IMPORT) &&
        ...
        {
            Class_5 MDI_Params_CommObj = (Class_5)CommObjectGetter.Invoke(Get_Index.DEMAND_ALL);
        ...
        public void Decode_Auto_Reset_Date(Base_Class MDI_Interval_CommObj)
        {
            if (MDI_Interval_CommObj.GetAttributeDecodingResult(0x04) == DecodingResult.Ready)
            {
                ...
                if (((Class_22)MDI_Interval_CommObj).executionTimeList != null && ((Class_22)MDI_Interval_CommObj).executionTimeList.Count > 0)
