...
{
    [XmlInclude(typeof(Param_Standard_Number_Profile))]
    [Serializable]
    public class Param_Standard_Number_Profile: IParam, ICloneable
    {
        #region Data_Members
        ...
        [XmlElement("CallerType", Type = typeof(AutoAnswerCallerType))]
        public AutoAnswerCallerType CallerType;

        #endregion

        public Param_Standard_Number_Profile()
        {
            Number = null;
            CallerType = AutoAnswerCallerType.WakeupSmsAndCalls;
        }
    ...
    public class Param_Number_Profile : Param_Standard_Number_Profile, ICustomStructure,IParam //, ICloneable
    {
        #region Data_Members
    ...
    public class Param_Number_ProfileHelper : INotifyPropertyChanged
    {
        ...
        public static byte[] ConvertFromValidNumberString(String phoneTxt,bool IsStandardParam)
        {
            try
            {
                ...
                else Array.Resize(ref _tArray, phoneTxt.Length);
                return _tArray;
            }
            catch (Exception)
            {
        ...
        public Param_Number_Profile AddParam_Number_Profile(Param_Number_Profile Arg)
        {
            ...
            if (total_Number_Profile_Count < Max_Number_Profile)
            {
                ...
                ///Init Number Profile
                Arg.Number = ConvertFromValidNumberString(DefaultMobileNumber,false);
                ///Init DataCall_Number
                Arg.Datacall_Number = ConvertFromValidNumberString(DefaultMobileNumber,false);
                ///Init Wakeup Profile
    ...
    public class Param_Standard_Number_ProfileHelper : INotifyPropertyChanged
    {
        public static string PropertyName = "Param_Standard_Number_Profile";
        public static int Max_Standard_Number_Profile = 04;

        public static Param_Standard_Number_Profile[] Param_Standard_Number_Profile_object_initialze(int Instances)
        {
            Param_Standard_Number_Profile[] Param_Number_Profile_object = new Param_Standard_Number_Profile[Instances];
            int count;
            for (count = 0; count < Instances; count++)
            {
                Param_Number_Profile_object[count] = new Param_Standard_Number_Profile();
                Param_Number_Profile_object[count].Number = new byte[16] { 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15 };
                Param_Number_Profile_object[count].CallerType = AutoAnswerCallerType.WakeupSmsAndCalls;
